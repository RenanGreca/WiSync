...
\title{LAN para Sincronização de Diretórios}
...
\chapter*{Relatório de Final de Semestre}
\begin{center}
Renan Greca
\end{center}

\addcontentsline{toc}{chapter}{\MakeUppercase{Relatório de Final de Semestre}}
\input{relatorio.tex}
\newpage
